...
const ThemeSwitcher = () => {
  return (
    <div className="fixed bottom-10 right-10 flex mt-6 bg-white justify-center dark:bg-gray-900 rounded-3xl p-1">
      <button
        type="button"
...
const SocialMedia = () => {
  return (
    <div className="fixed bottom-10 left-10 flex mt-6 bg-white justify-center dark:bg-gray-900 rounded-3xl p-1">
      <button
        type="button"
        aria-label="Use Dark Mode"
        onClick={() => {
...
export default function Footer({ copyrightText }) {
  return (
    <footer className=" pt-60 flex flex-col items-center ">
      <SocialMedia />
